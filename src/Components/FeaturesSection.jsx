            ...
            <div className="container mx-auto text-center">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="flex flex-col items-center text-center">
                        <img src={aromaImage} className="w-20 h-20 object-cover rounded-full mb-4" />
                    ...
                    <div className="flex flex-col items-center text-center">
                        <img src={qualityImage} className="w-20 h-20 object-cover rounded-full mb-4" />
                    ...
                    <div className="flex flex-col items-center text-center">
                        <img src={gradesImage} className="w-20 h-20 object-cover rounded-full mb-4" />
                    ...
                    <div className="flex flex-col items-center text-center">
                        <img src={pureGrades} className="w-20 h-20 object-cover rounded-full mb-4" />
